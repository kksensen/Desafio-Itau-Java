...
import com.kksensen.transacao_api.business.services.EstatisticasService;
...
public class EstatisticasController {
    ...
    @GetMapping
    @Operation(description = "Edpoint responsável por buscar estatísticas de transações")
    @ApiResponses(value = {
